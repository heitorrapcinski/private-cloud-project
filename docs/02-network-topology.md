...
Três spines distribuídos (1 por AZ), alojados nos racks FD2 (R2, R5, R8). Full-mesh triangular entre spines; cada leaf mantém 1 uplink 100GbE para cada spine.

```
              ┌──────────────┐       ┌──────────────┐       ┌──────────────┐
              │   Spine-01   │───────│   Spine-02   │───────│   Spine-03   │
              │   (AZ1/R2)   │       │   (AZ2/R5)   │       │   (AZ3/R8)   │
         ...
         │           │                      │                      │           │
    ┌────┴────┐ ┌────┴────┐            ┌────┴────┐            ┌────┴────┐      
    │Leaf-R1-A│ │Leaf-R1-B│   . . .    │Leaf-R5-A│    . . .   │Leaf-R9-B│  (18 leaves)
    │AS 65001 │ │AS 65001 │            │AS 65005 │            │AS 65009 │      
    └────┬────┘ └────┬────┘            └─────────┘            └─────────┘      
         │           │                                                          
         └─────┬─────┘ MLAG                                                     
         ┌─────┴─────┐                                                          
...
Fluxos inter-AZ usam ECMP balanceado entre os 3 spines. Falha de um spine mantém 2/3 da bandwidth underlay ativa.
...
|-------------|-----|------|
| Spine-01 (AZ1) | 65000 | iBGP full-mesh entre Spines (3 links triangulares) |
| Spine-02 (AZ2) | 65000 | iBGP full-mesh entre Spines |
| Spine-03 (AZ3) | 65000 | iBGP full-mesh entre Spines |
| Leaf-R1-A/B | 65001 | eBGP para os 3 Spines |
| Leaf-R2-A/B | 65002 | eBGP para os 3 Spines |
| Leaf-R3-A/B | 65003 | eBGP para os 3 Spines |
| Leaf-R4-A/B | 65004 | eBGP para os 3 Spines |
| Leaf-R5-A/B | 65005 | eBGP para os 3 Spines |
| Leaf-R6-A/B | 65006 | eBGP para os 3 Spines |
| Leaf-R7-A/B | 65007 | eBGP para os 3 Spines |
| Leaf-R8-A/B | 65008 | eBGP para os 3 Spines |
| Leaf-R9-A/B | 65009 | eBGP para os 3 Spines |
...
| compute-az1fd1-01..12 | 10.0.10.101-112 | Compute AZ1-FD1 (12 nós) |
| compute-az1fd2-01..10 | 10.0.10.113-122 | Compute AZ1-FD2 (10 nós — spine-01 em R2) |
| compute-az1fd3-01..12 | 10.0.10.125-136 | Compute AZ1-FD3 (12 nós) |
...
### Spine Switches (loopback addresses — BGP router IDs)

| Spine | Rack | Loopback | Função |
|-------|------|----------|--------|
| spine-01 | R2 (AZ1/FD2) | 192.168.255.1 | Core fabric AZ1 |
| spine-02 | R5 (AZ2/FD2) | 192.168.255.2 | Core fabric AZ2 |
